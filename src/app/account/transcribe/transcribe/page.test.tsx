...
describe('TranscribeProjectPage', () => {
  ...
  it('redirects to /account/transcribe if projectId is missing', async () => {
  ...
  it('redirects to /account/transcribe if projectId is invalid', async () => {
    (useSearchParams as Mock).mockReturnValue({
  ...
  it('redirects to the project page if images list is empty', async () => {
    (useSearchParams as Mock).mockReturnValue({
  ...
  it('prevents race conditions if projectId changes while a request is in flight', async () => {
    ...
    await waitFor(() => {
      ...
      expect(mockPush).not.toHaveBeenCalledWith(
        '/account/transcribe/project/?projectId=project-old',
      );
    });
  });
});
