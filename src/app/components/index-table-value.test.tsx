...
describe('IndexTableValue component', () => {
  ...
  it('should render the table cell element', () => {
    const { container } = render(
      <IndexTableValue matchedTokens={[]} value="Test value" />,
    );
  ...
  it('should highlight matched tokens in the value', () => {
    const { container } = render(
      <IndexTableValue matchedTokens={['Test']} value="Test value" />,
    );
    const tableCell = container.querySelector('td');
  ...
  it('should handle multiple matched tokens', () => {
    const { container } = render(
      <IndexTableValue matchedTokens={['Test', 'value']} value="Test value" />,
    );
    const tableCell = container.querySelector('td');
    expect(tableCell?.innerHTML).toContain(
      '<mark class="mark">Test</mark> <mark class="mark">value</mark>',
    );
  });
