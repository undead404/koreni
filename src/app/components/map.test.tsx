...
vi.mock("react-leaflet", () => ({
  __esModule: true,
  MapContainer: vi.fn(({ children }) => <div className="mapContainer">{children}</div>),
...
const defaultProps: MapProps = {
  points: [
    { coordinates: [51.505, -0.09], title: "A pretty CSS3 popup.<br>Easily customizable." },
...
describe("Map component", () => {
  ...
  it("should render the Head component with the script tag", () => {
    ...
    expect(scriptTag).toHaveAttribute("src", "https://unpkg.com/leaflet@1.9.4/dist/leaflet.js");
    expect(scriptTag).toHaveAttribute("integrity", "sha256-20nQCchB9co0qIjJZRGuk2/Z9VM+kNiyxNV1lvTlZBo=");
  });
  ...
  it("should render the Popup components with the correct titles", () => {
    ...
    expect(getByText("A pretty CSS3 popup.<br>Easily customizable.")).toBeInTheDocument();
