...
describe('formatBytes', () => {
  ...
  it('formats kilobytes correctly for values between 1024 and 1048575', () => {
    ...
    expect(formatBytes(1_048_575)).toBe('1024.0 КіБ');
  });

  it('formats megabytes correctly for values 1048576 and above', () => {
    expect(formatBytes(1_048_576)).toBe('1.0 МіБ');
    expect(formatBytes(1_572_864)).toBe('1.5 МіБ');
    expect(formatBytes(1_048_576 * 5.25)).toBe('5.3 МіБ');
  });
});
